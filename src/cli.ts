...
function showVersion() {
    ...
    if (fs.existsSync(packagePath)) {
        ...
        console.log(`Tatum MCP Server v${pkg.version}`);
    } else {
        console.log('Tatum MCP Server');
    }
}
...
function main() {
    ...
    if (!env.TATUM_API_KEY) {
        ...
        console.error('Set it using --api-key option or TATUM_API_KEY environment variable');
